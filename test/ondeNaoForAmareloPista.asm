...
preenche_asfalto:
    lui   $8, 0x1001          # início da tela
    ori   $9, $0, 0x80        # cor cinza escuro (0x808080)
    sll   $9, $9, 8
    ori   $9, $9, 0x80
    sll   $9, $9, 8
    ori   $9, $9, 0x80        # $9 = 0x808080 (cinza)

    ori   $10, $0, 131072     # total de pixels na tela (512×256)

loop_asfalto:
    beq   $10, $0, fim

    lw    $11, 0($8)          # carrega a cor atual do pixel
    xori  $11, $11, 0xFFFF00 # inverte os bits do amarelo (0x00FFFF00 → vira 0xFF0000FF)
    andi  $11, $11, 0xFF0000  # isola os bits do canal verde (amarelo tem verde full)
    bne   $11, $0, pinta_cinza   # se NÃO for amarelo → pinta cinza
