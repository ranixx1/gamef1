...
start_carro:
    lui $19, 0x1001
    addi $19, $19, 4608         # linha 9, coluna central

    # Cores
    ori $20, $0, 0xFF0000       # vermelho carro → 0x00FF0000
    ori $21, $0, 0x000000       # preto rodas
    ori $22, $0, 0xFFFF00       # amarelo pista
    ori $23, $0, 0x00FF00       # verde grama → 0x0000FF00

    # Desenha carro inicial
    sw $20, 0($19)
    sw $20, 4($19)
    sw $20, 8($19)
    sw $20, 12($19)
    ...
    ori $13, $0, 0xFFFFFF       # cor BRANCO (mortal)
...
# =============================================
# LOOP PRINCIPAL (ORDEM CORRETA AGORA!)
# =============================================
loop_carro:
