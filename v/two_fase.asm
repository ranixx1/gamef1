...
inicia_fase2:
    lui   $8, 0x1001        
    ori   $9, $0, 0xfcfaf2          # $9 = 0x0000FF00

    ori   $10, $0, 131072 #tela toda
    
loop_neve_2:  #background
    beq   $10, $0, comeca_pista_2
    sw    $9, 0($8)                   # pinta de verde
    addi  $8, $8, 4
    addi  $10, $10, -1
    j     loop_neve_2
...
comeca_pista_2:
    ...
    addi  $8, $8, 3072                
    lui   $9, 0x00FF
    ori   $9, $9, 0x0000FF            # amarelo
    ori   $10, $0, 11
    
loop7_2:
    beq   $10, $0, prepara_linha13_2
    sw    $9, 0($8)
    addi  $8, $8, 4
    addi  $10, $10, -1
    j     loop7_2
...
loop12_2:
    beq   $10, $0, primeira_curva_direita_2
    sw    $9, 0($8)
    addi  $8, $8, 4
    addi  $10, $10, -1
    j     loop12_2
...
#bordas pista
primeira_curva_direita_2:
    addi  $8, $8, -4
    ori   $10, $0, 45         # 46 quadradinhos para baixo

primeira_decida_2:
    beq   $10, $0, primeira_curva_esquerda_2
    addi  $8, $8, 512         # desce 1 linha (mesma coluna!) → +512 bytes
    sw    $9, 0($8)           # pinta o quadradinho da coluna 10
    addi  $10, $10, -1
    j     primeira_decida_2

primeira_curva_esquerda_2:
...
prepara_segunda_curva_direita_2:
    beq  $10,$0,segunda_curva_direita_2
    sw   $9, 0($8)
    addi $8,$8,4       # direita
    addi $10,$10,-1
    j    prepara_segunda_curva_direita_2
    
segunda_curva_direita_2:
    lui $8, 0x1001
    addi  $8, $8, 2560           # 5 × 512 = 2560 → vai pra linha 6
    addi  $8, $8, 468            # 117 × 4 = 468 → coluna DM (117)
    sw    $9, 0($8)              # pinta linha 6, coluna DM
...
loop_reto_ate_primeira_curva_direita_2:
    beq   $10, $0, curvas_superiores_borda_central
    addi  $8, $8, 4              # avança 1 quadradinho à direita
    sw    $9, 0($8)              # pinta amarelo
    addi  $10, $10, -1
    j     loop_reto_ate_primeira_curva_direita_2
    
curvas_superiores_borda_central_2: 
    lui   $8, 0x1001
    addi  $8, $8, 6732
    sw    $9, 0($8)               # T14
...
primeira_decida_central_2:
    beq   $10, $0, curvas_inferiores_borda_central_direita
    addi  $8, $8, 512         # desce 1 linha (mesma coluna!) → +512 bytes
    sw    $9, 0($8)           # pinta o quadradinho da coluna 10
    addi  $10, $10, -1
    j     primeira_decida_central_2

curvas_inferiores_borda_central_direita_2:
    addi  $8,$8,512
    addi  $8, $8, -4
    sw    $9,0($8)
    addi  $8,$8,512
...
left_borda_central_2:
    beq  $10,$0,curvas_inferiores_borda_esquerda_2
    sw   $9,0($8)
    addi $8,$8,-4      # esquerda
    addi $10,$10,-1
    j    left_borda_central_2      
	
curvas_inferiores_borda_esquerda_2:
    addi $8,$8, -512
    addi $8,$8, 0
    sw $9,0($8)
    addi $8,$8, -512
...
completa_ultima_curva_2:
    beq   $10, $0, start_carro_2
    sw    $9, 0($8)   
    addi  $8, $8, -512
    addi  $10, $10, -1
    j    completa_ultima_curva_2
...
start_carro_2:
    ...
    ori   $20, $0, 0x00FF0000         # cor do carro
    ori   $21, $0, 0x00000000         # Preto das rodas
    ori   $22, $0, 0xFFFFC0        #   borda
    ori   $23, $0, 0xfcfaf2        # fundo
...
loop_carro_2:
    ...
    addi  $24, $0, 'w'
    beq   $25, $24, move_cima_2
    addi  $24, $0, 's'
    beq   $25, $24, move_baixo_2
    addi  $24, $0, 'a'
    beq   $25, $24, move_esq_2
    addi  $24, $0, 'd'
    beq   $25, $24, move_dir_2
    j     redesenha_2

move_cima_2:
    addi  $19, $19, -512
    j     verifica_colisao_2
move_baixo_2:
    addi  $19, $19, 512
    j     verifica_colisao_2
move_esq_2:
